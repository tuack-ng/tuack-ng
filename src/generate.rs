use crate::prelude::*;
use crate::tuack_lib::config::SingleDataItem;
use crate::tuack_lib::config::load_contest_config;
use crate::tuack_lib::config::load_day_config;
use crate::tuack_lib::config::load_problem_config;
use crate::tuack_lib::config::save_contest_config;
